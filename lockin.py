    ...
    def setParameters(self,diff_2, diff,imp50,imp50_2,ac,Range,lowpass,rate,tc,c_2,amplification):       
        ...
        try:
            ...
            t1_sigOutIn_setting = [
                ...
                [['/', self.device, '/zctrls/',self.c,'/tamp/0/currentgain'], self.amplification],  #  Amplifier Setting for input 1
                [['/', self.device, '/zctrls/',self.c,'/tamp/1/currentgain'], self.amplification],  #  Amplifier Setting for input 2 
